...
st.write("Query the USDA FoodData Central dataset! This webapp is served on Streamlit Community Cloud and uses a Snowflake backend. The USDA-FDC dataset is available at [https://fdc.nal.usda.gov/](https://fdc.nal.usda.gov/download-datasets.html).")
...
if selection == None:
    ...
    with st.spinner('Getting details on product...'):
        ...
        image_search_term = brand_name + " product food photo transparent"
